...
class CoreDataManager{
    ...
    func addToFavoriteList(list:FavoriteList,soundSessionToAdd:SoundSession){
        
    }
    func readFavoriteList(list:FavoriteList)->[SoundSession]{
        return []
    }
    func removeFromFavoriteList(list:FavoriteList,soundSessionToDelete:SoundSession){
